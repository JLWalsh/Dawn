...
describe('ModuleSymbol', () => {
  ...
  const INTERNAL_SYMBOL: ISymbol = { visibility: SymbolVisibility.INTERNAL, name: 'bob' };
  const EXPORTED_SYMBOL: ISymbol = { visibility: SymbolVisibility.EXPORTED, name: 'alice' };

  describe('when upward lookup symbol that exists in module', () => {
    it('should find symbol', () => {
      const module = new ModuleSymbol(SymbolVisibility.INTERNAL, 'mike');
  ...
  describe('when upward lookup symbol that exists in parent module', () => {
    it('should find symbol', () => {
      const parentModule = new ModuleSymbol(SymbolVisibility.INTERNAL, 'mike');
      const module = new ModuleSymbol(SymbolVisibility.INTERNAL, 'alice', parentModule);
